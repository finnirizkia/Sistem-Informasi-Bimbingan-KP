...
function formInsertMahasiswa(){
	   $this->load->view('header');
    $this->load->view('admin/menu');
    $this->load->view('admin/insertMahasiswa');
    $this->load->view('footer');
	}
...
//dosen
	...
	function formInsertDosen(){
	   $this->load->view('header');
    $this->load->view('admin/menu');
    $this->load->view('admin/insertDosen');
    $this->load->view('footer');
	}
...
//kelas
	...
	function formInsertKelas(){
	   $this->load->view('header');
    $this->load->view('admin/menu');
    $this->load->view('admin/insertKelas');
    $this->load->view('footer');
	}
...
//jadwal
	...
	function formInsertJadwal(){
	   $this->load->view('header');
    $this->load->view('admin/menu');
    $this->load->view('admin/insertJadwal');
    $this->load->view('footer');
	}
